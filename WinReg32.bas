...
End Function
Public Function RegWriteBinary(ByVal hKey As Long, ByVal Key As String, ByVal SubKey As String, ByVal ValueName As String, ByVal Value As Variant) As Boolean
